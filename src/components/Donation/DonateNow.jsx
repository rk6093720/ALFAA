              ...
              <div className="mt-5">
                <div className="mt-5">
                  <div className="office-address mt-5">
                    <h2><b>ALFAA Office Address</b></h2>
                    <div className="address-details">
                      <div className="d-flex flex-row gap-2 mt-1rem">
                        <h2>3B, CASSIA COURT 91/1, COLES ROAD, FRASER TOWN, BANGALORE, KARNATAKA-560005</h2>
                      </div>
                  ...
                  <div className="pilot-project mt-5">
                    <h2><b>ALFAA Pilot Project</b></h2>
                    <div className="address-details">
                      <div className="d-flex flex-row gap-2 mt-1rem">
                        <h2>No 9, Omega Avenue, Mathrushree Layout, MARAGONDANAHALLI MAIN ROAD, TC Palya, KR Puram, Bangalore 560036 (Near Diamond PU College)</h2>
                      </div>
                      <div className="d-flex flex-row gap-2">
                        <h2><b>Contact Name: Ruby Singh</b></h2>
                      </div>
                      <div className="d-flex flex-row gap-2">
                        <h2>Tel: 080-25567762</h2>
                      </div>
                      <div className="d-flex flex-row gap-2">
                        <h2>Mobile: <b>+91 9741418103</b></h2>
                      </div>
                      <div className="d-flex flex-row gap-2">
                    ...
                    <div className="row">
                      <div className="col-xl-10 mb-4">
                        <div className="tp-donation-details__input">
                          <label>
                            Name <sup><CgAsterisk color="#e80000" /></sup>
                          </label>
                      ...
                      <div className="col-xl-10 mb-4">
                        <div className="tp-donation-details__input">
                          <label>
                            Phone Number <sup><CgAsterisk color="#e80000" /></sup>
                          </label>
                      ...
                      <div className="col-xl-10 mb-4">
                        <div className="tp-donation-details__input">
                          <label>
                            Enter Your Mail <sup><CgAsterisk color="#e80000" /></sup>
                          </label>
                      ...
                      <div className="col-xl-10 mb-4">
                        <div className="postbox__comment-agree-2 pb-3">
                          <div className="form-check">
                            ...
                            <label className="form-check-label text-theme" htmlFor="flexCheckDefault">
